...
import pl.soulsnaps.features.location.LocationResult
    ...
    private fun saveMemory() {
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                val latitude = when (locationResult) {
                    is LocationResult.Success -> locationResult.latitude
                    else -> null
                }
                val longitude = when (locationResult) {
                    is LocationResult.Success -> locationResult.longitude
                    else -> null
                }
                
                println("DEBUG: CaptureMomentViewModel.saveMemory() - current location: lat=$latitude, lng=$longitude")
