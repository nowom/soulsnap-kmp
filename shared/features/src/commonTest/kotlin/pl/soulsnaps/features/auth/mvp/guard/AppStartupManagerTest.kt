...
class AppStartupManagerTest {
    ...
    @Test
    fun `should check app state and show onboarding when not completed`() {
    ...
    @Test
    fun `should check app state and show dashboard when onboarding completed`() {
